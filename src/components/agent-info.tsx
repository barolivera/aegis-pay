    ...
    <div style={{ borderBottom: "1px solid #1a1a1a" }}>
      ...
      {open && (
        <div
          ...
          style={{ backgroundColor: "#050505", maxHeight: "80vh" }}
        >
          <div className="mx-auto max-w-2xl px-6 py-10 space-y-8">
                  ...
                  <div className="space-y-2">
                    {section.items.map((item) => (
                      <div key={item.label} className="flex gap-3 text-sm">
                        <span className="shrink-0 font-mono" style={{ color: "#555", minWidth: "100px" }}>
                          {item.label}
                        </span>
            ...
            <p className="text-center text-xs font-mono" style={{ color: "#333" }}>
